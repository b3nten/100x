...
> = Simplify<{
  [K in keyof R]: R[K] extends Route<infer S extends string>
    ? Route<Join<P, S>>
...
export type RouteHandlerArgs<T extends Route> =
...
export type RouteHandlersMap<RM extends RouteMap> = Readonly<{
  [RMKey in keyof RM]?: RM[RMKey] extends Route<infer U>
...
export type RoutesWithHandlerType<
  ...
  Handlers extends RouteHandlersMap<RM>,
> = {
