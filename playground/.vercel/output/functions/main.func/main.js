const m = {
  "src/clientMain/main.ts": {
    "file": "immutable/main.BYJvDDCC.js",
    "name": "main",
    "src": "src/clientMain/main.ts",
    "isEntry": true,
    "css": [
      "immutable/main.DL65rIRg.css"
    ]
  }
};
const manifest = m;
...
const clientEntry = {
  file: manifest["src/clientMain/main.ts"].file,
  css: manifest["src/clientMain/main.ts"].css ?? []
};
