import {createContext, createElement, type PropsWithChildren, use, useEffect} from "react";
...
export const useRouter = () => nonNullOrThrow(
    use(routerContext),
    "useRouter must be used within a RouterProvider",
)

export const RouterProvider = (props: PropsWithChildren<{ router: ClientRouter; }>) =>
    createElement(
