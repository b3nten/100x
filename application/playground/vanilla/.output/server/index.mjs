...
import { defineHandler as defineHandler$1 } from "nitro/h3";
...
const manifest$1 = { "src/clientMain/assets/styles.css": { "file": "assets/client-BuwQaUwx.js" }, "src/clientMain/main.ts": { "file": "assets/client-BuwQaUwx.js" }, "src/clientMain/assets/dynamic.css": { "file": "assets/dynamic-DvtG7N5B.js" }, "src/clientMain/dynamic.ts": { "file": "assets/dynamic-DvtG7N5B.js" } };
const services = {};
setupVite({ manifest: manifest$1, services });
...
const headers = ((m2) => function headersRouteRule(event) {
  for (const [key2, value] of Object.entries(m2.options || {})) {
    event.res.headers.set(key2, value);
  }
});
const m = {
  "../../src/runtimes/prod/client.ts": {
    "file": "assets/client-BuwQaUwx.js",
    "name": "client",
    "src": "../../src/runtimes/prod/client.ts",
    "isEntry": true,
    "dynamicImports": [
      "src/clientMain/dynamic.ts"
    ],
    "css": [
      "assets/client-5QYUduus.css"
    ]
  },
  "src/clientMain/dynamic.ts": {
    "file": "assets/dynamic-DvtG7N5B.js",
    "name": "dynamic",
    "src": "src/clientMain/dynamic.ts",
    "isDynamicEntry": true,
    "css": [
      "assets/dynamic-g7pxOomj.css"
    ]
  }
};
const manifest = m;
const clientEntry = "../../src/runtimes/prod/client.ts";
function resolveEntry(path2) {
  {
    return manifest[path2];
  }
}
const serverMain = defineHandler$1(async (ctx) => {
  console.log("client entry:", clientEntry);
});
const assets = {
  "/.vite/manifest.json": {
    "type": "application/json",
    "etag": '"20d-BSHoJ8zXqChZ7KE5cHVlLWTFHVE"',
    "mtime": "2025-10-20T23:32:09.679Z",
    "size": 525,
    "path": "../public/.vite/manifest.json"
  },
  "/assets/client-5QYUduus.css": {
    "type": "text/css; charset=utf-8",
    "etag": '"1c-6xfW+8j5evTDn8r+EuJg+WwQpl0"',
    "mtime": "2025-10-20T23:32:09.679Z",
    "size": 28,
    "path": "../public/assets/client-5QYUduus.css"
  },
  "/assets/client-BuwQaUwx.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": '"53e-al+93c52O/FUtbGZadVIUiMTmE8"',
    "mtime": "2025-10-20T23:32:09.679Z",
    "size": 1342,
    "path": "../public/assets/client-BuwQaUwx.js"
  },
  "/assets/dynamic-DvtG7N5B.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": '"18-rMLVrYSk9MTgP64ztTPn3KHzxhs"',
    "mtime": "2025-10-20T23:32:09.679Z",
    "size": 24,
    "path": "../public/assets/dynamic-DvtG7N5B.js"
  },
  "/assets/dynamic-g7pxOomj.css": {
    "type": "text/css; charset=utf-8",
    "etag": '"1b-yaUlBFdzA3X3Ovy1m0FgH7M2Y6U"',
    "mtime": "2025-10-20T23:32:09.679Z",
    "size": 27,
    "path": "../public/assets/dynamic-g7pxOomj.css"
  }
};
...
const _AwDktF = defineHandler((event) => {
...
const _lazy_EM_zps = defineLazyEventHandler(() => import("./chunks/_/renderer.mjs"));
const findRoute = (m2, p) => {
  if (p[p.length - 1] === "/") p = p.slice(0, -1) || "/";
  let s = p.split("/");
  s.length - 1;
  return { data: { route: "/**", handler: _lazy_EM_zps }, params: { "_": s.slice(1).join("/") } };
};
const findRoutedMiddleware = (m2, p) => {
  return [];
};
const globalMiddleware = [toEventHandler(_AwDktF)];
const serverEntry = toEventHandler(serverMain);
if (serverEntry) {
...
function getRouteRules(method, pathname) {
  const m2 = findRouteRules(method, pathname);
  if (!m2?.length) {
    return { routeRuleMiddleware: [] };
  }
  const routeRules = {};
  for (const layer of m2) {
...
function defineRenderHandler(render) {
  ...
  return defineHandler(async (event) => {
    ...
    await nitroApp2.hooks.callHook("render:before", ctx);
    if (!ctx.response) {
    ...
    await nitroApp2.hooks.callHook("render:response", ctx.response, ctx);
    if (ctx.response.headers) {
      for (const [key2, value] of Object.entries(ctx.response.headers)) {
        event.res.headers.set(key2, value);
      }
    }
